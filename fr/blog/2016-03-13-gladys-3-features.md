...
image: /fr/img/presentation/notebook-cover.jpg
...
<img alt="Schema Gladys évènements exemple" src="/fr/img/articles/gladys-3-annonce/event-process.png" />

Pour donner un exemple concret, cela donne ça :

<img alt="Schema Gladys évènements exemple" src="/fr/img/articles/gladys-3-annonce/event-process-example.png" />
