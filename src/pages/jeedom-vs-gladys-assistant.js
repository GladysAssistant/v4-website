...
import comparisonContent, {
  ...
  comparisonFaqFr,
  YOUTUBE_VIDEO_ID,
} from "../data/jeedomComparisonData";
  ...
  return (
    <main className={styles.main}>
      <div className={`container ${styles.container}`}>
          ...
          >
            ...
            <div className={styles.compareGrid}>
              ...
              <div className={`${styles.compareCol} ${styles.compareColHa}`}>
                <div className={styles.compareColTitle}>Jeedom</div>
        ...
        {/* VIDEO (only rendered when a video id is set) */}
        {videoSection}
...
export default function JeedomComparisonPage() {
  ...
  return (
    <Layout title={content.meta.title} description={content.meta.description}>
      <JsonLd data={getJeedomComparisonPageSchema(lang)} />
