          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                "DigitalOcean, dans un centre de données situé en Allemagne, pour l'hébergement de l'infrastructure Gladys Plus (API, sauvegardes, relais)",
          ...
          blocks: [
            {
              ...
              items: [
                ...
                "Mesure d'audience : les données collectées sont anonymes — aucune adresse IP n'est conservée, et l'identifiant de visite ne peut plus être relié à personne au-delà de 24 heures — elles ne sont donc pas soumises à une durée de conservation",
              ],
            },
          ],
        },
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "DigitalOcean, in a data center located in Germany, for hosting the Gladys Plus infrastructure (API, backups, relays)",
        ...
        blocks: [
          {
            ...
            items: [
              ...
              "Analytics: the data collected is anonymous — no IP address is kept, and the visit identifier can no longer be tied to anyone beyond 24 hours — so no retention period applies to it",
            ],
          },
        ],
      },
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            {
              type: "p",
              text: "L'infrastructure du service Gladys Plus (API, sauvegardes, relais) est hébergée par DigitalOcean, LLC, 101 Avenue of the Americas, New York, NY 10013, États-Unis, dans un centre de données situé en Allemagne. Les modèles d'IA Open-Weight utilisés par Gladys Plus sont hébergés par Scaleway, en France.",
            },
          ],
        },
        {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            type: "p",
            text: "The Gladys Plus infrastructure (API, backups, relays) is hosted by DigitalOcean, LLC, 101 Avenue of the Americas, New York, NY 10013, United States, in a data center located in Germany. The Open-Weight AI models used by Gladys Plus are hosted by Scaleway, in France.",
          },
        ],
      },
      {
