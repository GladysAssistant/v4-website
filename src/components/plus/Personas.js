        ...
        <div className={styles.personaCard}>
          ...
          <p className={styles.personaText}>
            <Translate id="gladysPlusPage.v2.personas.power.text">
              Enedis to track your electricity usage, Open-Weight AI models to
              talk to your home, remote camera
              streaming, MCP server to plug your favorite AIs into your home
              automation.
            </Translate>
          </p>
        </div>
