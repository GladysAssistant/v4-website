...
description: "Control your Overkiz devices (Somfy TaHoma, Connexoon, Cozytouch...). Free, open source, installable in one click."
...
| --- | --- | --- | --- |
| Overkiz account | `section` | No | Connect with the credentials of your Overkiz-based hub. Pick the server matching your hub, then enter the email and password of your provider account. Covers, lights, switches, sensors and water heaters are supported; heating devices are not mapped yet. |
