...
2. Click **Install**. Gladys pulls the Docker image (`ghcr.io/prohand/gladys-daikin-cloud:1.0.9`), starts it in a sandbox isolated from the core, and generates the integration's interface (devices, discovery and configuration).
