...
- **Sound mode, playback buttons or now-playing don't work as expected**: these rely on parts of
  ...
  [`scripts/debug-heos.js`](https://github.com/LM1LC3N7/gladys-denon-avr/blob/HEAD/./scripts/debug-heos.js) directly against the receiver instead of the
  container logs.
...
2. Click **Install**. Gladys pulls the Docker image (`ghcr.io/lm1lc3n7/gladys-denon-avr:1.0.18`), starts it in a sandbox isolated from the core, and generates the integration's interface (devices, discovery and configuration).
