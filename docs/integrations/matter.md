...
Gladys Assistant is compatible with Matter, so you can integrate Matter devices into your setup. Gladys acts as your **Matter controller**, running on your own machine: in most cases you do not need to buy a hub at all. If you are wondering which box you need, read our guide on [which Matter hub to choose](/matter-hub/).
