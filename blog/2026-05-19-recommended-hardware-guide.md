---
title: "New Guide: The Recommended Hardware to Get Started With Gladys"
description: "A new documentation page lists the recommended, Gladys-compatible hardware to build a reliable Zigbee home automation setup from scratch."
authors: pierregilles
image: /img/presentation/recommended-hardware-guide-en.jpg
slug: recommended-hardware-guide
---

Hey everyone!

I just added a new page to the documentation: **the recommended hardware** to build a reliable home automation setup with Gladys.

{/* truncate */}

👉 [See the recommended hardware page](/docs/installation/recommended-hardware/)
