...
Just before I get started: if you're looking for hardware to run Gladys on, a Beelink mini-PC is a great way to start in home automation with reliable, high-performance equipment.
...
👉 See the [recommended hardware guide](/docs/installation/recommended-hardware/) for our current picks.
