---
title: "Gladys 4.83 : Activité plus rapide, nettoyage DuckDB et 2FA Gladys Plus"
description: "Gladys 4.83 rend la page Activité instantanée même sur les très grosses bases, nettoie automatiquement les états orphelins dans DuckDB, et repense le parcours de double authentification Gladys Plus."
authors: pierregilles
image: /img/presentation/gladys-4-83-activity-duckdb-2fa-fr.jpg
slug: gladys-4-83-activity-duckdb-2fa
---

Salut à tous !

La version **4.83.0** est disponible ! 🚀

Après la grosse release 4.82 (journal d'activité + MQTT), cette version se concentre sur la **fiabilité**, les **performances** et quelques améliorations bien concrètes au quotidien, notamment pour les installations avec beaucoup d'historique, et pour Gladys Plus.
...
Sur une base de **448 millions d'états**, un filtre « Ouvertures » qui mettait 20 à 33 s à répondre affiche maintenant les premiers résultats en ~100 ms.

Merci à [@Terdious](https://community.gladysassistant.com/u/terdious) pour ce travail !
...
![Nettoyage des états orphelins DuckDB dans les tâches Gladys](../../../static/img/articles/gladys-4-83-activity-duckdb-2fa/01-duckdb-orphan-cleanup.png)
...
Merci encore à [@Terdious](https://community.gladysassistant.com/u/terdious) !
...
![Choix entre secondes et minutes sur le déclencheur de changement d'état](../../../static/img/articles/gladys-4-83-activity-duckdb-2fa/02-scene-trigger-seconds.png)

Les scènes existantes restent en minutes par défaut.

## 🖥️ Interface

- **Tableau de bord** : les types de widgets sont triés **alphabétiquement** selon la langue de l'interface (merci [@Will_71](https://community.gladysassistant.com/u/will_71))
- **Scènes** : idem pour les listes de déclencheurs et d'actions (merci [@Will_71](https://community.gladysassistant.com/u/will_71))
...
Un grand merci à [@Terdious](https://community.gladysassistant.com/u/terdious) et [@Will_71](https://community.gladysassistant.com/u/will_71) pour leurs contributions à cette version, et merci à toute la communauté pour vos retours et vos tests, surtout ceux d'entre vous qui font tourner Gladys sur de très grosses bases d'historique : c'est grâce à vous qu'on peut valider ces perfs en conditions réelles.
