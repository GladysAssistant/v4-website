---
title: "Intégration Tuya pour Gladys Assistant"
sidebar_label: "Tuya"
description: "Prises, compteurs, clims, fil pilote, caméras, sonnettes, aspirateurs Tuya / Smart Life (cloud+LAN). Gratuite, open source, installable en un clic."
...
2. Cliquez sur **Installer**. Gladys télécharge l'image Docker (`ghcr.io/terdious/gladys-tuya:1.15.0`), la démarre dans un bac à sable isolé du cœur, et génère l'interface de l'intégration (appareils, découverte et configuration).
...
Tuya nécessite Gladys `>=4.86.1`. Le catalogue dans Gladys se rafraîchit toutes les heures : une nouvelle version est donc disponible au plus tard une heure après sa sortie.
