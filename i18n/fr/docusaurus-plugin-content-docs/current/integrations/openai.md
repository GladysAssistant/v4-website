...
L'intégration IA est incluse dans l'abonnement **Gladys Plus** (formule Plus). Elle est activée automatiquement dès que votre instance est connectée à Gladys Plus. [Créez votre compte](/fr/plus/) si ce n'est pas encore fait.
...
- « Quelle température fait-il dans le jardin ? »
...
Les modèles open-weight utilisés par Gladys Plus sont hébergés par Scaleway dans des data centers français. Vos requêtes sont traitées en Europe.

En savoir plus sur la [page Gladys Plus](/fr/plus/) et dans la [documentation Gladys Plus](/fr/docs/plus/intro).
