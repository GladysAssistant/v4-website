...
![Envoyer un message Zigbee2Mqtt](../../../../../static/img/docs/fr/scenes/send-a-zigbee2mqtt-message-action/send-a-zigbee2mqtt-message.png)
...
![Topic de l'appareil](../../../../../static/img/docs/fr/scenes/send-a-zigbee2mqtt-message-action/device-topic.png)
...
![Message de l'appareil](../../../../../static/img/docs/fr/scenes/send-a-zigbee2mqtt-message-action/device-message.png)
...
![Récupérer valeur capteur](../../../../../static/img/docs/fr/scenes/send-a-zigbee2mqtt-message-action/get-device-value.png)
...
![Envoyer un message avec variable injectée](../../../../../static/img/docs/fr/scenes/send-a-zigbee2mqtt-message-action/send-a-zigbee2mqtt-message-with-injected-variable.png)
