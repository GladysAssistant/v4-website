...
Nous mettons à disposition une image Raspbian toute prête : <a href="https://gladysassistant.com/download/latest" rel="nofollow">Télécharger Gladys Assistant Raspberry Pi OS latest rev5</a>.
